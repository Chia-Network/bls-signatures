...
describe('Threshold', () => {
    it('Should be able to verify secret fragment', function () {
        ...
        const commitments = [
            [
                PublicKey.fromBytes(Buffer.from('93075db5c398bd2682dfab816a920023e8c0337a42fafc93c0bfab937400b6e7dafa5e456f2fa127979ff9c9a140127b', 'hex')),
                PublicKey.fromBytes(Buffer.from('1304180c71f137a1dc4c39c6e997285f55d9dd11f53c52f8fc7702a5b08f529190ffc01b8b6b28b64ee9704f26ca02c3', 'hex')),
            ],
            [
                PublicKey.fromBytes(Buffer.from('05888f29bcad893fd7997b8b5b49fcfa276df701ded1452ab6b5d40c101333af1348a041878a970c40643ba63d7e8468', 'hex')),
                PublicKey.fromBytes(Buffer.from('8af360512dfa9d18eb6cd375e3e87ec713b8ebc68853a41b6be31c3d19b6373b9f5e80845214cdd244b0a6ecd8d4bf51', 'hex')),
            ],
            [
                PublicKey.fromBytes(Buffer.from('83fb5434aef48a2478f535fb69043c6653a9cf51a33d6c956ba75c0e1da749fba2652a933cb0e091ceef7ab8a7b69488', 'hex')),
                PublicKey.fromBytes(Buffer.from('93adf1615e23b04e16d5cae180d46e613c7f17c6173cd73079c8c0f851e688f2597b158599bb77e1b1467c43bd6c74ac', 'hex')),
            ],
        ];
        const fragments = [
            [
                PrivateKey.fromBytes(Buffer.from('0b5205ed2c9aa86391dc8c7de15efa868073d83fb782f92de81e3d21916e296e', 'hex'), false),
                PrivateKey.fromBytes(Buffer.from('56720e3ca7a2d6856fa16ef94eb2c2957066b849cea8a4da7fde0613efbc5401', 'hex'), false),
                PrivateKey.fromBytes(Buffer.from('49d151bb34da1f1957077e231e7cdf564f418b74cb9b3b1c751714cb649631c3', 'hex'), false),
            ],
            [
                PrivateKey.fromBytes(Buffer.from('2d88c55ae942997b8c2e8259cd4910bf686137377f2e9679db93c69251cf7593', 'hex'), false),
                PrivateKey.fromBytes(Buffer.from('1ac23ad6960e2dc6f693b0907d810c80821848d6c880137a5eec1ea6db165135', 'hex'), false),
                PrivateKey.fromBytes(Buffer.from('621c2977b244fcae5f7fc24e94afad8e693b45c517fc5a06f17fff6d55167ff2', 'hex'), false),
            ],
            [
                PrivateKey.fromBytes(Buffer.from('4fbf84c8a5ea8a9386807835b93326f8504e962f46da33c5cf0950031230c1b8', 'hex'), false),
                PrivateKey.fromBytes(Buffer.from('53000ec3ae170250b0bfca2fb5f12e70e7877d66c255de193dfa3738c6704e6a', 'hex'), false),
                PrivateKey.fromBytes(Buffer.from('067959e106125cfb34be2e720140a3c12f775c12645f1cf26de8ea104596ce20', 'hex'), false),
            ]
        ];
